...
Publications: The homepage lists six publication records. Two AAAI 2027 submissions are under review and not yet public: "When KL Regularization Fails in Online Reasoning RL: A Token-Level Gradient Contract" and "Advantage Scale Calibration Imbalance in Group-Relative Optimization under Low-Variance Rewards: Diagnosis and Bounded Recovery." "ChronoMem: Interpretable Event Memory for LLM-Augmented Time-Series Forecasting" is an in-preparation ICASSP 2027 manuscript and not yet public. "Decision-Aware Memory Cards: Counterfactual-Inspired Context Selection and Compression for Tool-Using LLM Agents" is a preprint (arXiv:2606.08151) with Xinyu as first author. "Evaluation and Optimization of Efficient Text Search Algorithms" is under review for ICASSP 2026 with Xinyu as first author. "Price-Aware Dynamic Heterogeneous Hypergraph Network for Next Basket Recommendation" was published at ICASSP 2025 with Xinyu as second author.
...
Experience: From February 2026 to present, Xinyu has been an AI Agent Researcher at Alibaba Group / TaoTian Group, working on Xianyu Quality Inspection for photo-compliance and physical-defect inspection of second-hand products. From October 2025 to December 2025, he was a Senior Research Scientist in Baidu's ERNIE Foundation Model Core Team, working on DAPO-based multilingual post-training and alignment. From March 2025 to September 2025, he was a Research Scientist in Tencent Hunyuan's Text-to-Text Pipeline Team, working on Yuanbao AI Search, web-scale data processing, and multilingual evaluation. From February 2024 to March 2025, he was a Research Scientist in Tencent Hunyuan Strategy Group 4, working on biomedical enhancement, video processing, data recognition, and audio alignment. From November 2023 to January 2024, he was a Research Assistant Intern at the Institute of Information Engineering, Chinese Academy of Sciences, working on LLM-based insider-threat detection and knowledge graphs. From May 2021 to May 2022, he was a Software Engineer in Mico World / Yoho, working on international social products.
